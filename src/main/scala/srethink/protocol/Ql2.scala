...
object VersionDummy {
	@beans.BeanProperty val defaultInstance = new VersionDummy()
	...
	object Version extends net.sandrogrzicic.scalabuff.Enum {
		...
		val V0_3 = new EnumVal { val name = "V0_3"; val id = 1601562686 }
	...
	object Protocol extends net.sandrogrzicic.scalabuff.Enum {
		sealed trait EnumVal extends Value
		val _UNINITIALIZED = new EnumVal { val name = "UNINITIALIZED ENUM VALUE"; val id = -1 }

		val PROTOBUF = new EnumVal { val name = "PROTOBUF"; val id = 656407617 }
		val JSON = new EnumVal { val name = "JSON"; val id = 2120839367 }

		val PROTOBUF_VALUE = 656407617
		val JSON_VALUE = 2120839367

		def valueOf(id: Int) = id match {
			case 656407617 => PROTOBUF
			case 2120839367 => JSON
			case _default => throw new net.sandrogrzicic.scalabuff.UnknownEnumException(_default)
		}
		val internalGetValueMap = new com.google.protobuf.Internal.EnumLiteMap[EnumVal] {
			def findValueByNumber(id: Int): EnumVal = valueOf(id)
...
final case class Query (
	...
	`globalOptargs`: Seq[Query.AssocPair] = Vector.empty[Query.AssocPair]
) extends com.google.protobuf.GeneratedMessageLite
	with com.google.protobuf.MessageLite.Builder
...
object Query {
	@beans.BeanProperty val defaultInstance = new Query()
	...
	object AssocPair {
		@beans.BeanProperty val defaultInstance = new AssocPair()
...
object Frame {
	@beans.BeanProperty val defaultInstance = new Frame()
...
final case class Backtrace (
	`frames`: Seq[Frame] = Vector.empty[Frame]
) extends com.google.protobuf.GeneratedMessageLite
	with com.google.protobuf.MessageLite.Builder
...
object Backtrace {
	@beans.BeanProperty val defaultInstance = new Backtrace()
...
final case class Response (
	...
	`token`: Option[Long] = None,
	`response`: Seq[Datum] = Vector.empty[Datum],
...
object Response {
	...
	object ResponseType extends net.sandrogrzicic.scalabuff.Enum {
		...
		val SUCCESS_FEED = new EnumVal { val name = "SUCCESS_FEED"; val id = 5 }
...
final case class Datum (
	...
	`rArray`: Seq[Datum] = Vector.empty[Datum],
	`rObject`: Seq[Datum.AssocPair] = Vector.empty[Datum.AssocPair]
...
object Datum {
	@beans.BeanProperty val defaultInstance = new Datum()
...
final case class Term (
	...
	`args`: Seq[Term] = Vector.empty[Term],
	`optargs`: Seq[Term.AssocPair] = Vector.empty[Term.AssocPair]
...
object Term {
	@beans.BeanProperty val defaultInstance = new Term()
	...
	object TermType extends net.sandrogrzicic.scalabuff.Enum {
		...
		val HTTP = new EnumVal { val name = "HTTP"; val id = 153 }
		...
		val RANDOM = new EnumVal { val name = "RANDOM"; val id = 151 }
		val CHANGES = new EnumVal { val name = "CHANGES"; val id = 152 }
		val ARGS = new EnumVal { val name = "ARGS"; val id = 154 }
